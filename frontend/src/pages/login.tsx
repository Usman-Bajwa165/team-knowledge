      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
          <div className="card shadow-sm p-4">
            <h2 className="mb-3" style={{ color: '#8B2D2D' }}>Welcome back</h2>
            <p className="text-muted">Sign in to your account and continue contributing.</p>
            ...
            <form onSubmit={onSubmit} className="mt-3">
              ...
              <div className="d-flex justify-content-between align-items-center mb-3">
                <button className="btn btn-danger" disabled={loading}>{loading ? 'Signing in…' : 'Sign in'}</button>
